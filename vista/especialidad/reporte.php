...
$result = mysqli_query($connString, "SELECT * FROM especialidad") or die("database error:". mysqli_error($connString));
$header = mysqli_query($connString, "SHOW columns FROM especialidad");
