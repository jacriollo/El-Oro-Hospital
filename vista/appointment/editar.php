		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form method="get" action="../vista/appointment/obtenerclase.php">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<a href="../vista/appointment/BorrarRegistro.php?codcit=<?php echo $va['codcit']; ?>" class="btn btn-danger"><span class="fa fa-times"></span> Eliminar</a>
				</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<a href="../vista/appointment/desactivar.php?codcit=<?php echo $va['codcit']; ?>" class="btn btn-success"><span class="fa fa-times"></span> Activar</a>
				</div>
