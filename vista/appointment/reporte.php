...
$display_heading = array('codhor'=>'#', 'nomhor'=> 'Horarios', 'nombre'=> 'DOCTOR');

$result = mysqli_query($connString, "SELECT horario.codhor, horario.nomhor, doctor.coddoc, doctor.cedula, doctor.nombre, doctor.apellido, doctor.correo, horario.fere FROM horario INNER JOIN doctor ON  horario.coddoc = doctor.coddoc") or die("database error:". mysqli_error($connString));
