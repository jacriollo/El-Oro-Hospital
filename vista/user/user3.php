					...
					<li class="nav-item">
						...
						<div class="collapse" id="forms">
							<ul class="nav nav-collapse">
								<li>
									<a href="../user_doctor/mostrar3.php">
										...
										<div class="row mt-3">
											<div class="col-md-4">
												<div class="form-group form-group-default">
													<label>Cédula</label>
													<input type="text" class="form-control" value="<?php echo $d->cedula; ?>" name="cedula" placeholder="cedula">
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group form-group-default">
													<label>Nombre</label>
													<input type="text" class="form-control" value="<?php echo $d->nombre; ?>" name="nombre" placeholder="nombre">
												</div>
											</div>
										</div>
										<div class="row mt-3">
											<div class="col-md-4">
												<div class="form-group form-group-default">
													...
													<input type="text" class="form-control" value="<?php echo $d->apellido; ?>" name="apellido" placeholder="apellido">
												</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group form-group-default">
													...
													<input type="text" class="form-control" value="<?php echo $d->telefono; ?>" name="telefono" placeholder="">
												</div>
											</div>
