...
<body>
																...
																<!--<td>
																	...
																	<?php  } else { ?>
																		...
																		<form method="get" action="javascript:inactivo('<?php echo $row['id']; ?>')">
																			<span class="text-danger pl-3"><strong>Administrador</strong></span>
																		</form>
	...
	<script>
		function activo(codpaci) {
			...
			$.ajax({
				type: "GET",
				url: "../assets/ajax/editar_estado_activo_usuarios.php?id=" + id,
			}).done(function(data) {
				window.location.href = '../folder/usuarios.php';
			})
		...
		function inactivo(codpaci) {
			...
			$.ajax({
				type: "GET",
				url: "../assets/ajax/editar_estado_inactivo_usuarios.php?id=" + id,
			}).done(function(data) {
				window.location.href = '../folder/usuarios.php';
			})
		}
	...
	?>
		...
		?>
			...
			$sql2 = "INSERT INTO usuarios(nombre,usuario,clave,cargo)VALUES ('$nombre','$usuario','$clave','$cargo')";
