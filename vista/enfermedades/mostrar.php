...
<body>
										...
										<div class="table-responsive">
											<table id="add-row" class="display table table-striped table-hover">
												...
												<tbody>
													...
													$sql = 'SELECT enfermedad.codenfer,enfermedad.nombre FROM enfermedad';
															...
															<tr>
																...
																<td>
																	<div class="form-button-action">
																		...
																		<a href="#editRowModal_<?php echo $va["codenfer"]; ?>" title="Editar" data-backdrop="false" class="btn btn-link btn-primary btn-lg" data-toggle="modal"><i class="fa fa-edit"></i></a>

																		<a href="#deleteRowModal_<?php echo $va["codenfer"]; ?>" title="Eliminar" data-backdrop="false" class="btn btn-link btn-danger btn-lg" data-toggle="modal"><i class="fa fa-times"></i></a>
	...
	<script>
		function activo(codenfer) {
			...
			$.ajax({
				type: "GET",
				url: "../assets/ajax/editar_estado_activo_enfermedades.php?id=" + id,
			}).done(function(data) {
				window.location.href = '../folder/enfermedades.php';
			})
		...
		function inactivo(codenfer) {
			...
			$.ajax({
				type: "GET",
				url: "../assets/ajax/editar_estado_inactivo_enfermedades.php?id=" + id,
			}).done(function(data) {
				window.location.href = '../folder/enfermedades.php';
			})
		}
	...
	if (isset($_POST["agregar"])) {
		...
		$sql = "select * from enfermedad where nombre='$nombre' ";
	...
	?>
		...
		?>
			...
			$sql2 = "INSERT INTO enfermedad(nombre)VALUES ('$nombre')";
				...
				?>
					...
					<script type="text/javascript">
						Swal.fire({
							...
							window.location = "../folder/enfermedades.php";
						});
					</script>
