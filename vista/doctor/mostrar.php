...
<body>
										...
										<div class="table-responsive">
											<table id="add-row" class="display table table-striped table-hover">
												...
												<tbody>
													...
													$sql = 'SELECT doctor.coddoc,doctor.cedula,doctor.nombre,doctor.apellido, doctor.sexo,doctor.fechanaci,doctor.correo,doctor.telefono,doctor.direccion,doctor.ciudad,doctor.usuario,doctor.clave, doctor.cargo,doctor.estado FROM doctor';
															...
															<tr>
																...
																<td>
																	<div class="form-button-action">
																		...
																		<!--<a href="#editRowModal_<?php echo $va["coddoc"]; ?>" title="" data-backdrop="false" class="btn btn-link btn-primary btn-lg" data-toggle="modal">
																			<i class="fa fa-edit"></i>
																		</a>
																		<a href="#deleteRowModal<?php echo $va["coddoc"]; ?>" title="" data-backdrop="false" class="btn btn-link btn-danger btn-lg" data-toggle="modal" data-target="#deleteRowModal<?php echo $va['coddoc']; ?>">
																		...
																		<a href="#deleteRowModal_<?php echo $va["coddoc"]; ?>" title="Eliminar" data-backdrop="false" class="btn btn-link btn-danger btn-lg" data-toggle="modal"><i class="fa fa-times"></i></a>

																		<!--<a href="#deleteRowModal_<?php echo $va['coddoc']; ?>" class="btn btn-link btn-danger btn-lg" data-toggle="modal" title="" data-original-title="Delete Task">
																			<i class="fa fa-times"></i>
																		</a>-->
	...
	?>
		...
		?>
			...
			$sql2 = "INSERT INTO doctor(cedula,nombre,apellido,codespe,sexo,fechanaci,correo,telefono,direccion,ciudad,usuario,clave,cargo,estado)VALUES ('$cedula','$nombre','$apellido','$codespe','$sexo','$fechanaci','$correo','$telefono','$direccion','$ciudad','$usuario','$clave','$cargo','1')";
