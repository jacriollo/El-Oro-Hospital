										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
													...
													<form method="POST" action="../vista/horario/obtener.php?id=<?php echo $va['codhor']; ?>">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="../vista/horario/BorrarRegistro.php?codhor=<?php echo $va['codhor']; ?>" class="btn btn-danger"><span class="fa fa-times"></span> Eliminar</a>
            </div>
