<!-- Modal-edit -->
<div class="modal fade" id="editRowModal_<?php echo $va['codrepo']; ?>" aria-labelledby="myModalLabel" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form method="POST" action="../vista/reportes/obtener.php?id=<?php echo $va['codrepo']; ?>">
