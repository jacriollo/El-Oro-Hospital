...
<body>
											...
											<div class="col-sm-6">
												<div class="card">
													<div class="card-body">
														...
														<a href="../vista/appointment/reporte.php" class="btn btn-primary">Descargar Reporte</a>
													</div>
												</div>
											</div>
											<div class="col-sm-6">
												<div class="card">
													<div class="card-body">
														<h5 class="card-title">Reportes de Médicos</h5>
														<p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
														<a href="../vista/doctor/reporte.php" class="btn btn-primary">Descargar Reporte</a>
													</div>
												</div>
											</div>
										</div>
										...
										<!--<div class="table-responsive">
											<table id="add-row" class="display table table-striped table-hover">
												...
												<tbody>
													...
													$sql = 'SELECT reporte.codrepo,reporte.nombre,reporte.fecha FROM reporte';
															...
															<tr>
																...
																<td>
																	<div class="form-button-action">
																		...
																		<a href="#editRowModal_<?php echo $va["codrepo"]; ?>" title="Editar" data-backdrop="false" class="btn btn-link btn-primary btn-lg" data-toggle="modal"><i class="fa fa-edit"></i></a>

																		<a href="#deleteRowModal_<?php echo $va["codrepo"]; ?>" title="Eliminar" data-backdrop="false" class="btn btn-link btn-danger btn-lg" data-toggle="modal"><i class="fa fa-times"></i></a>
	...
	<script>
		function activo(codenfer) {
			var id = codenfer;
			$.ajax({
				type: "GET",
				url: "../assets/ajax/editar_estado_activo_reportes.php?id=" + id,
			}).done(function(data) {
				window.location.href = '../folder/reportes.php';
			})

		}

		// Editar estado inactivo
		function inactivo(codenfer) {
			var id = codenfer;
			$.ajax({
				type: "GET",
				url: "../assets/ajax/editar_estado_inactivo_reportes.php?id=" + id,
			}).done(function(data) {
				window.location.href = '../folder/reportes.php';
			})
		}
	...
	if (isset($_POST["agregar"])) {
		...
		$sql = "select * from reporte where nombre='$nombre', fecha='$fecha' ";
	...
	?>
		...
		?>
			...
			$sql2 = "INSERT INTO reporte(nombre,fecha)VALUES ('$nombre','$fecha')";
				...
				?>
					...
					<script type="text/javascript">
						Swal.fire({
							...
							window.location = "../folder/reportes.php";
						});
					</script>
